...
WebUI.waitForElementVisible(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_ApplicationsCatalog/div_Risk Control Unit ApplicationRCU Apps c_31ac98'), 
    10)
...
WebUI.click(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCash/button_Cari'))

WebUI.click(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCash/button_Persetujuan'))

WebUI.click(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCashDetail/div_OUTSTANDING PETTY CASH'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCashDetail/select_Pilih OpsiDisetujuiDikembalikan'), 
    '0', true)

WebUI.setText(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCashDetail/textarea_Catatan_b3-b1-b8-b10-TextArea_Catatan'), 
    'Done, in progress')

WebUI.click(findTestObject('Object Repository/Sprint1/SPV-Persetujuan/Page_PersetujuanPettyCashDetail/button_Submit'), FailureHandling.STOP_ON_FAILURE)
