...
WebUI.callTestCase(findTestCase('Sprint-1/Login-CBU/Login-PIC-CBU'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCash/button_Cari_1'))
...
WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah'))

WebUI.uploadFile(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/div_Drag  drop files orBrowseSupported form_a30bce'), 
    Lorem1)

WebUI.uploadFile(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/div_Drag  drop files orBrowseSupported form_a30bce'), 
    Lorem2)

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah_1'))

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah'))

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah_1'))

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Lihat Dokumen'))

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Tutup'))
...
WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah_2'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.uploadFile(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/div_Drag  drop files orBrowseSupported form_a30bce_1'), 
    Lorem1)

WebUI.uploadFile(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/div_Drag  drop files orBrowseSupported form_a30bce_1'), 
    Lorem2)

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Unggah_3'))

WebUI.click(findTestObject('Object Repository/Sprint1/PIC-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCashDetail/button_Submit'))
